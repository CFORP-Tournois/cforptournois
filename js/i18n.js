...
const translations = {
  fr: {
    ...
    tournamentInfo: {
      ...
      ffaTop10: "Pour être qualifié : top 10 au classement FFA et au moins 1 kill sur les 3 rondes.",
      ...
      ffaFlow3: "Loadout : une fois la carte choisie, vous avez peu de temps pour configurer votre équipement (armes autorisées uniquement). La partie démarre immédiatement après le vote – choisissez vite pour ne pas manquer de points !",
      ...
      elimFlow4: "Format : 5 rondes, premier à gagner 5 rondes remporte le match. Chaque ronde = 1 kill pour gagner (premier kill de la ronde). Rondes de 1 min 30 s. Si aucun kill → gagnant tiré au sort.",
  ...
  en: {
    ...
    tournamentInfo: {
      ...
      ffaTop10: "To qualify: top 10 in FFA standings and at least 1 kill across the 3 rounds.",
      ...
      ffaFlow3: "Loadout: once the map is chosen, you have a short time to set up your equipment (authorized weapons only). The game starts immediately after the vote – choose quickly so you don't miss out on points!",
      ...
      elimFlow4: "Format: 5 rounds, first to win 5 rounds wins the match. Each round = 1 kill to win (first kill of the round). Rounds last 1 min 30 s. If no kill → winner decided at random.",
