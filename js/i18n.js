...
const translations = {
  fr: {
    ...
    signup: {
      ...
      step1Prefix: "Rejoignez la réunion Google Meet le jour du tournoi – le lien est sur la page « Plus d'infos »",
      step2: "Consultez les tableaux pour voir votre position",
      step3: "Soyez prêt 15 minutes avant le début",
      emailProvidedInfo: "Si vous avez fourni votre courriel, vous recevrez les informations pour rejoindre le tournoi quelques jours avant le début.",
      noEmailInfo: "Si vous n'avez pas fourni votre courriel, veuillez soit enregistrer ce site et récupérer les informations",
      here: "ICI",
      noEmailOr: ", soit nous écrire à",
  ...
  en: {
    ...
    signup: {
      ...
      step1Prefix: "Join the Google Meet on tournament day – the link is on the More info page",
      step2: "Check the brackets to see your position",
      step3: "Be ready 15 minutes before start time",
      emailProvidedInfo: "If you submitted your email, you will receive the join info for the tournament a few days before it begins.",
      noEmailInfo: "If you did not provide your email, please either save this website and get the information",
      here: "HERE",
      noEmailOr: ", or email us at",
